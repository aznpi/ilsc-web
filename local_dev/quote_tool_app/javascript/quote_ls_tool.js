...
const getProgramsList = function(){
  let isEdit = $('input[name=quote_edit]').val(),
      ...
      tableId = schoolProgramListTable,
        queryParam = '&campus__in='+campusId+'&show_quote_tool__eq=1&program_type__ne='+omitProgram+'&category__eq=Programs&orderBy=program_name',

    ...
    if (typeof tableId !== 'undefined') {
        ...
        $.get(api_url).done(function (data) {
            ...
            if (dataObject.length > 0) {
                ...
                ageQualifyMessage = "<option disabled selected value=''>No Start Dates Available. Possible reason - There is an age requirement for this program. Minimum age:" + minAge + "</option>";
...
const startDateAction = function (element) {
    ...
    $(function () {
        ...
        if (selectedParentSchool == 'ELS') {
            $(".accommodation-checkin-date-picker,.accommodation-checkout-date-picker").attr('disabled', false);
        } else {

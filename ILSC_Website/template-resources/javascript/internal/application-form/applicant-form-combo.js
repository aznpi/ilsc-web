...
const printStartDates = function (selectedProgram, element, minAge, maxAge, inputName,programType) {
    ...
    sessionVar = selectedCurrentSchool == 'Language School' | selectedCurrentSchool == 'ELS' ? 6 : selectedCurrentSchool == 'Greystone College' ? 5 : 6;
